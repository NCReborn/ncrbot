...
module.exports = {
  ...
  async execute(interaction) {
    ...
    // 1. Get the admin channel object (change this if your bot uses a different way to fetch channels)
    const adminChannel = interaction.client.channels.cache.get('1324990321393930240');
    ...
    try {
      if (!c2 || old2 === null || new2 === null) {
        ...
        // 2. Pass adminChannel as argument
        await sendSingleChangelogMessages(interaction.channel, adminChannel, diffs, slug, old1, new1, collectionName, process.env.NEXUS_API_KEY);
        ...
        // 3. Pass adminChannel as argument
        await sendCombinedChangelogMessages(interaction.channel, adminChannel, diffs1, diffs2, exclusiveChanges, slug1, old1, new1, slug2, old2, new2, process.env.NEXUS_API_KEY);
