    ...
    try {
      if (!c2 || old2 === null || new2 === null) {
        ...
        await sendSingleChangelogMessages(
          interaction.channel, adminChannel, diffs, slug, old1, new1, collectionName, process.env.NEXUS_API_KEY
        );
        ...
        await sendCombinedChangelogMessages(
          interaction.channel, adminChannel, diffs1, diffs2, exclusiveChanges,
          slug1, old1, new1, slug2, old2, new2, process.env.NEXUS_API_KEY
        );
